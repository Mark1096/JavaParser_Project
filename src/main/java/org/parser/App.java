...
//    public static int getIndexParameter(MethodDeclaration methodDeclaration,
//                                        String variable) {
//        for (int i = 0; i < methodDeclaration.getParameters().size(); i++) {
//            if (methodDeclaration.getParameter(i)
//                    .getNameAsString().equals(variable))    // confronto tra il nome del parametro i-esimo e quello passato in input
...
//    public static VariableDeclarator findVariable(MethodDeclaration
//                                                          methodDeclaration,
//                                                  String variable) {
...
//    public static boolean verifyArrayContent(MethodDeclaration userMethod,
//                                             MethodDeclaration recursive_method,
//                                             Expression userElement,
//                                             Expression element) {
//        boolean ris = true;
//
...
//                if (!verifyArrayContent(userMethod, recursive_method, userElement, element))
//                    return false;
//                isValue = false;
//            }
//
...
//                if (userElement.asMethodCallExpr().getScope().isPresent() !=
//                        element.asMethodCallExpr().getScope().isPresent()) {
...
//        if (!compareElementContent(userMethod, recursive_method,
//                userVariableValue, variableValue))
//            result = false;
//
//        return result;
//    }
...
//    public static boolean compareMethodsElements(MethodDeclaration userMethod,
//                                                 MethodDeclaration recursive_method,
...
//        if (index != userIndex ||
//                (variable == null && userVariable != null) ||
//                (variable != null && userVariable == null)) {
...
//        if (index == -1 && variable == null && !userElement.equals(element)) {
...
//
//            if (!compareElementContent(userMethod, recursive_method, userConditionExpr,
//                    conditionExpr)) {
